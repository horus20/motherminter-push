export default {
  ...
  create: {
    ...
    fixedDetail: 'Allows you to create a specified number of wallets. Any number you want, 5, 40, 1000. You will be given options to download it or send it to your email after creation.',
    ...
    passToCompany: 'Pass to manage campaign',
  ...
  action: {
    ...
    placeholder: 'Your coffee shop is really cool. I enjoyed my cappuccino with a new york cheesecake. I will definitely come back again.',
  ...
  main: {
    ...
    timeloop: 'TIME LOOP, a cool browser game<br>where you earn money by winning in battles.',
